...
multianova_out <- invisible(lapply(s, multi_anova, clinical_variable = "grade", dataset = Schmidt_M[["data"]]))
...
```
```{r}
all(c(c(strsplit(genes3,split =",")[[1]]),"grade") %in% colnames(Schmidt_M[["data"]]))
```
```{r}
