...
gse54934_pheno <- gse54934_cd %>%         # rename and adjust variables
                     mutate(
                            ...
                            "disease" = ifelse(grepl("Meningioma", sample_id),
                                               "Meningioma",
                                               histology)    
                    ) %>% mutate(
                                "grade" = factor(grade, 
...
```
```{r}
save(TorresMartin_M, file = "~/Documents/Thesis/mgm_eda/datasets_scripts/GSE54934_Torres-Martin_M_KO.Rda") 
```