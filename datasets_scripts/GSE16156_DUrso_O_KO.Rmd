...
gse16156_pheno <- gse16156_cd %>%         # rename and adjust variables
                     mutate(
                            ...
                            "grade" = factor(grade, 
                                             levels = c("Grade I", "Grade II", "Grade III", "none"), 
...
```
```{r}
save(DUrso_O, file = "~/Documents/Thesis/mgm_eda/datasets_scripts/GSE16156_DUrso_O_KO.Rda") 
```
