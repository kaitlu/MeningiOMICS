...
gse55609_pheno <- gse55609_cd %>% mutate(
                                              "grade" = factor(grade, 
                                                               levels = c("WHO grade I", "WHO grade II", "WHO grade III", "none"), 
...
```
```{r}
save(Yeh_T, file = "~/Documents/Thesis/mgm_eda/datasets_scripts/GSE55609_Yeh_T_KO.Rda") 
```